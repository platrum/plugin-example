...
1. Установить wsl 2 (подробно узнать о [wsl](https://learn.microsoft.com/ru-ru/windows/wsl/about) вы можете здесь).  Для установки следуйте инструкции на сайте.
...
4. Склонировать репозиторий `git clone`
5. Далее задаем переменные окружения
