...
В этом шаге мы оживим эту страницу:

* [добавим базовую верстку с таблицей и панелью фильтров](#Базовая-верстка)
* [добавим сайдбар с формой для заполнения данных](#Добавление-сайдбара-с-формой)
...
В данном разделе мы разберем, как сохранять, загружать и удалять данные и разберем синтаксис фильтров, которые пригодятся при загрузке или удалении данных.
В конце мы добавим управление 
