...
3. Установить в подсистему архиватор. Выполнив команду `sudo apt install zip`
...
sudo bash
```
6. Настройте переменные окружения. Вместо 'api-key' вставьте в запрос api ключ вашего проетка, вместо 'host' вставьте в запрос хост вашего проекта.
```
